...
export const colorPalleteSize = 30;

<span style="display: flex; gap: 15px; float: right;">
  <div
    style={{
...
<ArticleFigure
    imagePaths={["maya-building-generator/fig_01.png","maya-building-generator/fig_02.png"]}
    side="center"
    height="200"
    alt="Figure showing primitives as resulting building."
/>
