...
The model was provided in the open position, the goal was to animate it opening from a closed position, matching a given reference. I did this using a combination of KineFX, Vex, and Vellum.
...
<ArticleFigure
    imagePath="etc-flower/houdini_screenshot_03.png"
    side="none"
    fillWidth="true"
    alt="Screenshot of Houdini."
/>
...
<ArticleFigure
    imagePath="etc-flower/houdini_screenshot_01.png"
    side="none"
    fillWidth="true"
    alt="Screenshot of Houdini."
/>
...
## Open Position
<ArticleFigure
    imagePath="etc-flower/houdini_screenshot_02.png"
    side="none"
    fillWidth="true"
    alt="Screenshot of Houdini."
/>
...
<ArticleFigure
    imagePath="etc-flower/texture_screenshot_01.png"
    side="none"
    fillWidth="true"
    alt="Screenshot of Gimp pretending to be Photoshop because I can't run Photoshop anymore but need a visual aid."
/>
