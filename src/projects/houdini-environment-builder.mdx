...
This project was created during my postgraduate degree. While the original goal was to create a simple garden builder, I wanted to challenge myself and see how far I could take it. Specifically, I wanted to push what's possible with HDA interfaces, python viewerstates, and persistant states in HDAs.
